...
.Notes
    Wiki проекта: https://github.com/pashalvov/PoshRemoteRegistry/wiki/%D0%94%D0%BE%D0%B1%D1%80%D0%BE-%D0%BF%D0%BE%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D1%82%D1%8C
    Нашёл баг или хочешь доработку: https://github.com/pashalvov/PoshRemoteRegistry/pulls
    Сайт проекта: https://github.com/pashalvov/PoshRemoteRegistry
#>
...
function Get-RegValueData {
    [CmdletBinding(SupportsShouldProcess=$false,
        ...
        HelpURI='https://github.com/pashalvov/PoshRemoteRegistry/wiki')]
    Param
    (
...
.Example
    # Удалить ключ в реестре
    Remove-RegKeyValue -ComputerName 'имя_компа' -RegistryHive LocalMachine -RegistryKeyPath 'SOFTWARE\WOW6432Node\PoshRemoteRegistry\' -ValueName 'Version'

.Example
    # Удалить раздел в реестре
    Remove-RegKeyValue -ComputerName 'имя_компа' -RegistryHive LocalMachine -RegistryKeyPath 'SOFTWARE\WOW6432Node\' -ChildKey 'PoshRemoteRegistry'
...
.Example
    # Удалить ключ в реестре
    Write-RegValueData -ComputerName 'имя_компа' -RegistryHive LocalMachine -RegistryKeyPath 'SOFTWARE\WOW6432Node\PoshRemoteRegistry\' -ValueName 'Version'

.Example
    # Удалить раздел в реестре
    Write-RegValueData -ComputerName 'имя_компа' -RegistryHive LocalMachine -RegistryKeyPath 'SOFTWARE\WOW6432Node\' -ChildKey 'PoshRemoteRegistry'
